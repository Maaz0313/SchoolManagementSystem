...
namespace SchoolManagementSystem.Controllers
{
    public class TimeTblTablesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "TimeTableID,UserID,ClassSubjectID,StaffID,StartTime,EndTime,Day,IsActive")] TimeTblTable timeTblTable)
        {
            if (string.IsNullOrEmpty(Convert.ToString(Session["UserName"])))
            {
                return RedirectToAction("Login", "Home");
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TimeTableID,UserID,ClassSubjectID,StaffID,StartTime,EndTime,Day,IsActive")] TimeTblTable timeTblTable)
        {
            if (string.IsNullOrEmpty(Convert.ToString(Session["UserName"])))
            {
                return RedirectToAction("Login", "Home");
