...
namespace SchoolManagementSystem.Controllers
{
    public class ExamMarksTablesController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            var examMarksTables = db.ExamMarksTables.Include(e => e.ClassSubjectTable).Include(e => e.ExamTable).Include(e => e.StudentTable).Include(e => e.UserTable);
        ...
        public ActionResult Create([Bind(Include = "MarksID,ExamID,ClassSubjectID,StudentID,UserID,TotalMarks,ObtainMarks")] ExamMarksTable examMarksTable)
        {
            if (string.IsNullOrEmpty(Convert.ToString(Session["UserName"])))
            {
                return RedirectToAction("Login", "Home");
