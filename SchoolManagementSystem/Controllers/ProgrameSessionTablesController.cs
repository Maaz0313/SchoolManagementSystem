...
namespace SchoolManagementSystem.Controllers
{
    public class ProgrameSessionTablesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ProgrameSessionID,UserID,SessionID,ProgrameID,Details,RegDate,Description")] ProgrameSessionTable programeSessionTable)
        {
            if (string.IsNullOrEmpty(Convert.ToString(Session["UserName"])))
            {
                return RedirectToAction("Login", "Home");
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ProgrameSessionID,UserID,SessionID,ProgrameID,Details,RegDate,Description")] ProgrameSessionTable programeSessionTable)
        {
            if (string.IsNullOrEmpty(Convert.ToString(Session["UserName"])))
            {
                return RedirectToAction("Login", "Home");
