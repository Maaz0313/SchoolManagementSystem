...
namespace SchoolManagementSystem.Controllers
{
    public class ExamTablesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ExamID,UserID,Title,StartDate,EndDate,Description")] ExamTable examTable)
        {
            if (string.IsNullOrEmpty(Convert.ToString(Session["UserName"])))
            {
                return RedirectToAction("Login", "Home");
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ExamID,UserID,Title,StartDate,EndDate,Description")] ExamTable examTable)
        {
            if (string.IsNullOrEmpty(Convert.ToString(Session["UserName"])))
            {
                return RedirectToAction("Login", "Home");
