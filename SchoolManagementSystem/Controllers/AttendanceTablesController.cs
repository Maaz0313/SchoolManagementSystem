...
namespace SchoolManagementSystem.Controllers
{
    public class AttendanceTablesController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            var attendanceTables = db.AttendanceTables.Include(a => a.ClassTable).Include(a => a.StudentTable);
        ...
        public ActionResult Create([Bind(Include = "AttendanceID,SessionID,ClassID,StudentID,AttendDate,AttendTime")] AttendanceTable attendanceTable)
        {
            if (string.IsNullOrEmpty(Convert.ToString(Session["UserName"])))
            {
                return RedirectToAction("Login", "Home");
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AttendanceID,SessionID,ClassID,StudentID,AttendDate,AttendTime")] AttendanceTable attendanceTable)
        {
            if (string.IsNullOrEmpty(Convert.ToString(Session["UserName"])))
            {
                return RedirectToAction("Login", "Home");
