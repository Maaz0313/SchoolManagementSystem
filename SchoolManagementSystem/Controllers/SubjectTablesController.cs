...
namespace SchoolManagementSystem.Controllers
{
    public class SubjectTablesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "SubjectID,UserID,Name,RegDate,Description,TotalMarks")] SubjectTable subjectTable)
        {
            if (string.IsNullOrEmpty(Convert.ToString(Session["UserName"])))
            {
                return RedirectToAction("Login", "Home");
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "SubjectID,UserID,Name,RegDate,Description,TotalMarks")] SubjectTable subjectTable)
        {
            if (string.IsNullOrEmpty(Convert.ToString(Session["UserName"])))
            {
                return RedirectToAction("Login", "Home");
