...
namespace SchoolManagementSystem.Repository
{
    public class ResumeRepository : IResumeRepository
    {
        ...
        {
            int EmployeeResumeID = _dbContext.EmployeeResumeTables.Where(p => p.EmployeeID==EmployeeID)
        ...
        {
            //var workExperienceList = _dbContext.EmployeeWorkExperienceTables.Where(w => w.EmployeeResumeID == EmployeeID);
